...
public class CarcassAllSameLures {
    @Shadow(remap = false)
    @Final
    public static PropertyEnum<BlockEvolutionLure.EnumType> VARIANT;
    ...
    private boolean checkBlocks(World worldIn, BlockPos pos, BlockEvolutionLure.EnumType lureType) {
        ...
        return cornersAreLures && (!SRPMultiplierConfigHandler.lures.forceCarcassSameLureVariant || cornersAreSameVariant);
    }
}
