...
public abstract class EntityAIGiveEffectsAreaMixin {
    ...
    @Unique
    private static List<PotionEffect> getEffect(int parasiteId){
        ...
        return effectsFromConfig.get(parasiteId);
    }
    ...
    private String[] dontSplitList(String instance, String regex, Operation<String[]> original){
        List<PotionEffect> effects = getEffect(this.parent.getParasiteIDRegister());
